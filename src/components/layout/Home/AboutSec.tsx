...
function AboutSec() {
  return (
    <div className="relative z-[-1] w-full px-[50px] p-[80px] lg:px-[30px] md:px-[30px] sm:px-[30px] sx:px-[30px] bg-[url('/images/about-bg.jpg')] bg-no-repeat">
      <div className="div_container">
        <div className="secTitleWrap mb-[2.1875rem] text-center">
          <div className="secTitle">
            <h1 className="heading_h1 text-black font-bold relative text-center">
          ...
          <div className="aboutUs flex relative mt-[5.9375rem] w-full p-[1.25rem] lg:p-[1.875rem]">
          <div className="aboutUsBg before:bg-gray bg-gray absolute inset-0 left-0 rounded-[10px] bg-[url('/images/about.jpg')] bg-cover bg-center bg-no-repeat bg-blend-multiply before:absolute before:inset-0 before:z-[1] before:rounded-[10px] before:opacity-70 sm:rounded-[1.25rem] before:sm:rounded-[1.25rem] md:rounded-[3.125rem] before:md:rounded-[3.125rem] xl:left-[10.9375rem] 2xl:left-[10.9375rem]"></div>
          <div className="grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-2 gap-[1.875rem]">
            <div className="aboutImg relative ml-0 mt-[-5.625rem] lg:ml-[-1.875rem]">
              <NextImage
                className="relative z-[1] w-full rounded-[10px] sm:rounded-[1.25rem] md:rounded-[3.125rem]"
            ...
            <div className="aboutCapWrap w-full">
              <div className="aboutCap relative z-[1] overflow-hidden rounded-[10px] p-5 sm:rounded-[1.25rem] md:rounded-[3.125rem] md:p-10 lg:px-[3.5rem] lg:py-12 xl:px-20 xl:pb-[4.375rem] xl:pt-[4.6875rem]">
                <div className="aboutCapBg opc8 rounded-in absolute inset-0 z-[-1] bg-white bg-cover bg-center bg-no-repeat opacity-90 sm:rounded-[1.25rem] md:rounded-[3.125rem]"></div>
                <h3 className="heading_h3 text-left text-black">
                  Hi,
                </h3>
                <h2 className="text-[20px] text-left text-black">
                  My name is{" "}
                  <span className="text-[1.5rem] font-bold uppercase text-[#f6371c] md:text-[1.875rem]">
                    Muhammd Owais
                  </span>
                </h2>
                <ul className="mt-6 text-left text-black grid grid-cols-1 gap-5">
                  <li className="grid grid-cols-3 gap-4 2xl:text-[1rem] xl:text-[1rem] lg:text-[1rem] md:text-[1rem] sm:text-[14px] sx:text-[14px]">
                    <strong className="col-span-1 font-bold uppercase">
                      Age:
                    </strong>
                    <span className="col-span-2 font-semibold text-[14px]">
                      24
                    </span>
                  </li>
                  <li className="grid grid-cols-3 gap-4 2xl:text-[1rem] xl:text-[1rem] lg:text-[1rem] md:text-[1rem] sm:text-[14px] sx:text-[14px]">
                    ...
                    <span className="col-span-2 font-semibold">
                      <a
                        className="hover:text-[#f6371c] text-[14px]"
                  ...
                  <li className="grid grid-cols-3 gap-4 2xl:text-[1rem] xl:text-[1rem] lg:text-[1rem] md:text-[1rem] sm:text-[14px] sx:text-[14px]">
                    ...
                    <span className="col-span-2 font-semibold">
                      <a
                        className="hover:text-[#f6371c] text-[14px]"
                        href="mailto:mohammadowaisfaiz@gmail.com"
                        title=""
                      >
                  ...
                  <li className="grid grid-cols-3 gap-4 2xl:text-[1rem] xl:text-[1rem] lg:text-[1rem] md:text-[1rem] sm:text-[14px] sx:text-[14px]">
                    ...
                    <span className="col-span-2 flex items-center uppercase">
                      <svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
                        viewBox="0 0 8 16"
                        className="fill-[#f6371c]"
                        height="1.5rem"
                        width="1.5rem"
                ...
                <svg
                  ...
                  y="0px"
                  viewBox="0 0 425 165"
                  className="mt-[2.375rem] h-[4.5rem] fill-[#f6371c]"
                >
                  <g>
