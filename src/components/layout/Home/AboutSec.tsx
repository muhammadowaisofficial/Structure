...
function AboutSec() {
  return (
    <div className="relative z-[-1] w-full p-[50px] bg-[url('/images/about-bg.jpg')] bg-no-repeat">
      <div className="div_container">
        <div className="secTitleWrap mb-[2.1875rem] text-center">
          <div className="secTitle">
            <h1 className="heading_h1 text-black font-bold relative">
              ...
              <div className="aboutCap relative z-[1] overflow-hidden rounded-[10px] p-5 sm:rounded-[1.25rem] md:rounded-[3.125rem] md:p-10 lg:px-[3.5rem] lg:py-12 xl:px-20 xl:pb-[4.375rem] xl:pt-[4.6875rem]">
                ...
                <ul className="mt-6 text-left text-black grid grid-cols-1 gap-5">
                  <li className="grid grid-cols-3 gap-4 text-[1rem] md:text-[1.125rem]">
                    <strong className="text-desc3 font-Poppins col-span-1 font-bold uppercase">
                      Age:
                    </strong>
                    <span className="text-desc2 font-NunitoSans col-span-2 font-semibold">
                      24
                    </span>
                  </li>
                  <li className="grid grid-cols-3 gap-4 text-[1rem] md:text-[1.125rem]">
                    ...
                    <span className="text-desc2 font-NunitoSans col-span-2 font-semibold">
                      <a
                        className="text-desc2 font-NunitoSans font-semibold hover:text-[#f6371c]"
                  ...
                  <li className="grid grid-cols-3 gap-4 text-[1rem] md:text-[1.125rem]">
                    ...
                    <span className="text-desc2 font-NunitoSans col-span-2 flex items-center font-semibold uppercase">
                      <svg
                        stroke="currentColor"
                        fill="currentColor"
                        stroke-width="0"
